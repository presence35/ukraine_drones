...
| `DebugLogScreen.kt` | Full-screen Debug log: newest-first rows of alert/threat decisions with an "ago" + absolute timestamp, day/night, sound + vibration chips, "Notification fired" or "No notification — \<reason\>", Clear button. |
