...
object Strings {
    ...
    private val UA = StringSet(
        ...
        guideZonesD1 = "Повільні (дрони): червона зона — до 60 км, жовта — до 180 км.",
        guideZonesD2 = "Швидкі (ракети, КАБ): червона зона — до 10 хв, жовта — до 30 хв до прильоту.",
    ...
    private val EN = StringSet(
        ...
        guideZonesD1 = "Slow (drones): red zone within 60 km, yellow within 180 km.",
        guideZonesD2 = "Fast (missiles, guided bombs): red zone within 10 min, yellow within 30 min to arrival.",
