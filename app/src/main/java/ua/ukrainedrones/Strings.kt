...
object Strings {
    ...
    private val UA = StringSet(
        ...
        guideTogglesSummary = "Кожен із 8 типів загроз можна показати чи вимкнути.",
        guideTogglesD1 = "Натисни картку в Налаштуваннях → Загрози, щоб увімкнути чи вимкнути тип.",
        guideTogglesD2 = "Вимкнений тип у смузі загроз показується сірим.",
    ...
    private val EN = StringSet(
        ...
        guideTogglesSummary = "Each of the 8 threat types can be shown or silenced.",
        guideTogglesD1 = "Tap a card in Settings → Threats to enable or disable a type.",
        guideTogglesD2 = "A disabled type appears greyed out in the threat strip.",
