...
object Strings {
    ...
    data class StringSet(
        ...
        val iconSetComingSoonLabel: String,
    ...
    private val UA = StringSet(
        ...
        nightModeDesc = "Окремий сценарій на ніч: розклад, звук і власні зони.",
    ...
    private val EN = StringSet(
        ...
        nightModeDesc = "A separate scenario for the night: schedule, sound and its own zones.",
        ...
        iconSetComingSoonLabel = "Coming soon",
