...
val iconSetTitle: String get() = misc.iconSetTitle
    ...
    private fun uaOnboarding() = Onboarding(
        ...
        wizardJustFunDesc = "Анімації знешкодження, проліт літака, лічильник та заспокійливі написи — це лише для настрою. Не впливають на моніторинг і тривоги. Налаштувати детально можна в ⚙.",
    ...
    private fun uaSettings() = Settings(
        ...
        officialAlertScopeDesc = "Уся область за замовчуванням. Увімкни, щоб лише твоє місто.",
